    ...
    <div>
        ...
        <div v-if="locations.length > 0" class="map_filter">
            <div class="maphighlight__box">
                ...
                <Availables class="availables-mobile" :type="type" :amountAvailables="amountAvailables" />
            </div>
            <div class="select__box">
                <Select v-if="locations.length > 0 && rangeFilter.length > 0" :locations="locations" @change="changeRange" :rangeFilter="rangeFilter" />
                <Availables class="availables-desk" :amountAvailables="amountAvailables" :type="type" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            imgSet: [{
                name: 'lindavista',
                url: 'https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/lindavista/lindavista-main.png',
                width: '1332',
                height: '1346',
                id: 43,
                route: 'lindavista/detalles',
                nivel: 'availability',
                levelId: 0,
                transform: '',
                viewBox: '0 0 1332 1346'
