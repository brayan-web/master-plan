  ...
  <div class="main__details">
    ...
    <main class="main__box" :class="columnReverse">
      ...
      <div class="item2 item">
        ...
        <form-quote v-else :stateForm="stateForm" :typeImage="typeImage" @click="hiddeRecibirInfo"/>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      closeIcon: faXmark,
      deviceWidth: 0,
      typeImage: "modeloCasas",
      desarrollo: "Cañadas Casas",
      urlImg: "ca%C3%B1adas/casas/modelos",
      amenitiesData: [
        {
