  ...
  <div class="main__details">
    ...
    <main class="main__box" :class="columnReverse">
      ...
      <div class="item2 item">
        ...
        <form-quote :desarrollo="desarrollo" :typeImage="typeImage" v-else :stateForm="stateForm" @click="hiddeRecibirInfo"/>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  data() {
    return{
      ...
      desarrollo: "Cañadas Departamentos",
      urlImg: 'ca%C3%B1adas/deptos/modelos',
      amenitiesData: [
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/lagos.svg",
          description: "Lagos"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/canchasfut.svg",
          description: "Canchas de futbol y basquetbol"
        },
        {
        ...
        },
        {
          ...
          description: "Gimnasio al aire libre"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/cenadores.svg",
          description: "Cenadores"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/accesoespectacular.svg",
          description: "Espectacular acceso"
        },
        {
