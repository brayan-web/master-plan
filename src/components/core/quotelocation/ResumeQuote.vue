<template>
  <div class="resume__quote-content">
    ...
    <div class="radio__button-box">
      <radio-button-quote :class="disabled" @onUpdatePlan="updateActivePlan" :activePlan="activePlan" content="content1" value="12" :interes="9" text="12 meses"/>
      <radio-button-quote :class="disabled" @onUpdatePlan="updateActivePlan"  :activePlan="activePlan" content="content2" value="24" :interes="12" text="24 meses"/>
      <radio-button-quote :class="disabled" @onUpdatePlan="updateActivePlan"  :activePlan="activePlan" content="content3" value="36" :interes="14" text="36 meses"/>
      <radio-button-quote :class="disabled" @onUpdatePlan="updateActivePlan"  :activePlan="activePlan" content="content4" value="60" :interes="14" text="60 meses"/>
    ...
    <div class="btn_box">
      <a href="" :class="disabled" @click.prevent="_getFinancial()" class="btn btn__resume">{{(loaderFinancial == true ? 'cotizando...' : 'cotizar')}}</a>
    </div>
    ...
    <div class="content__resume" v-if="resumeBox">
      ...
      <p>Monto a financiar con interés: <span>${{formatValue(financial.interestAmount + financial.financedAmount)}}</span></p>
  ...
  methods: {
   ...
   try {
     /*let body = {
       ...
       customerName: `${this.user.name} ${this.user.lastName}`,
       months: this.activePlan,
       city: this.user.cp,
     };
     await this.sendFinancial(body)*/
     Swal.fire({
       icon: "success",
   ...
   setTimeout(function(){
        console.log("hello world despues de 2 segundos")
   },2000)
    },
    formatValue(value){
