        ...
        <div v-if="locations.length > 0" class="map_filter">
            <div class="maphighlight__box">
                <h1 class="caption__select">
                    <span>{{img.name}}</span>
                    <span>Seleccione un nivel, clic para ver detalles</span>
                </h1>
                <map-highlight-deptos :img="img" :existFilter="existFilter" :desarrollo="desarrollo" :url="url" :type="type" :nivel="nivel" />
                <!-- <Button :img="img" :id="id" :desarrollo="desarrollo" :nivel="nivel"  :levelId="levelId" :url="url"/>-->
                <div class="line_horizontal"></div>
                <Availables class="availables-mobile" :type="type" :existFilter="existFilter" @onUpdateModel="updateActiveModel" />
            </div>
            <div class="select__box">
                <Availables class="availables-desk" :type="type" :existFilter="existFilter" @onUpdateModel="updateActiveModel" />
            </div>
        </div>
    </div>
</template>
    ...
    data() {
        return {
            ...
            torres: {
                TORREA: {
                    name: 'TORRE A',
                    url: 'https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/torrespanorama/TORREA/TorreA.png',
                    width: '1080',
                    id: this.$route.params.id,
                    levelId: 0,
                    nivel: 'towerStageLevel',
                ...
                TORREB: {
                    name: 'TORRE B',
                    url: 'https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/torrespanorama/TORREB/TorreB.png',
                    width: '1080',
                    id: this.$route.params.id,
                    levelId: 0,
                    nivel: 'towerStageLevel',
                ...
                TORREC: {
                    name: 'TORRE C',
                    url: 'https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/torrespanorama/TORREC/TorreC.png',
                    width: '1080',
                    id: this.$route.params.id,
                    levelId: 0,
                    nivel: 'towerStageLevel',
