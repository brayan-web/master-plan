...
export default {
  ...
  data() {
    return {
      ...
      closeIcon: faXmark,
      deviceWidth: 0,
      typeImage: "modeloDeptosTP",
      desarrollo: "Torres Panorama",
      urlImg: '/imgs/torrespanorama/modelos',
      amenitiesData: [
        {
        ...
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/Asoleadero.svg",
        ...
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/Asadores.svg",
          description: "Asadores"
        },
        {
        ...
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/canchasmulti.svg",
          description: "Cancha multideportiva"
        },
        {
        ...
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/Escalera.svg",
          description: "Escalera de servicio"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/Aire.svg",
          description: "Preparación para instalación de aire acondicionado"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/caseta.svg",
          description: "Seguridad y accesos controlados las 24 horas"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/estacionamiento.svg",
          description: "Cajones de estacionamiento techado"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/aislante.svg",
          description: "Muros de concreto"
        },
        {
          icon: "https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/icons/ventana2.svg",
          description: "Doble acristalamiento"
        },
        {
