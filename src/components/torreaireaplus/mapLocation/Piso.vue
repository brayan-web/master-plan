  ...
  data() {
    return {
      ...
      niveles: {
        ...
        NIVEL4: {
          name: 'https://kiritek-web-documents.s3.us-west-2.amazonaws.com/masterplan-dashboard/imgs/torreaireaplus/niveles/4N.png',
          url: '/imgs/torreaireaplus/niveles/4N.png',
          width: '1087',
          id: 48,
          levelId: this.$route.params.idPiso,
          nivel: 'availability',
